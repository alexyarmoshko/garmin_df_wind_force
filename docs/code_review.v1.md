...
In [proxy/src/met-eireann.ts](c:/Users/alex/repos/garmin_df_wind_force/proxy/src/met-eireann.ts), the parser only keeps entries whose timestamp is greater than or equal to `Date.now()`:

- [proxy/src/met-eireann.ts:57](c:/Users/alex/repos/garmin_df_wind_force/proxy/src/met-eireann.ts)
- [proxy/src/met-eireann.ts:71](c:/Users/alex/repos/garmin_df_wind_force/proxy/src/met-eireann.ts)
...
- [README.md:17](c:/Users/alex/repos/garmin_df_wind_force/README.md)
- [docs/REQUIREMENTS.md:49](c:/Users/alex/repos/garmin_df_wind_force/docs/REQUIREMENTS.md)
...
In [proxy/src/index.ts](c:/Users/alex/repos/garmin_df_wind_force/proxy/src/index.ts), `cacheKey` is computed before the fresh upstream fetch:

- [proxy/src/index.ts:61](c:/Users/alex/repos/garmin_df_wind_force/proxy/src/index.ts)
...
- [proxy/src/index.ts:70](c:/Users/alex/repos/garmin_df_wind_force/proxy/src/index.ts)
- [proxy/src/index.ts:76](c:/Users/alex/repos/garmin_df_wind_force/proxy/src/index.ts)
- [proxy/src/index.ts:86](c:/Users/alex/repos/garmin_df_wind_force/proxy/src/index.ts)
