...
In [source/FetchManager.mc:86](c:/Users/alex/repos/garmin_df_wind_force/source/FetchManager.mc#L86), the fetch state is advanced before the HTTP response has succeeded:

- [source/FetchManager.mc:86](c:/Users/alex/repos/garmin_df_wind_force/source/FetchManager.mc#L86)
- [source/FetchManager.mc:92](c:/Users/alex/repos/garmin_df_wind_force/source/FetchManager.mc#L92)
- [source/FetchManager.mc:94](c:/Users/alex/repos/garmin_df_wind_force/source/FetchManager.mc#L94)
- [source/FetchManager.mc:95](c:/Users/alex/repos/garmin_df_wind_force/source/FetchManager.mc#L95)

But the success callback only persists data when the response is `200` and otherwise just clears `_fetchInProgress`:

- [source/FetchManager.mc:125](c:/Users/alex/repos/garmin_df_wind_force/source/FetchManager.mc#L125)
- [source/FetchManager.mc:127](c:/Users/alex/repos/garmin_df_wind_force/source/FetchManager.mc#L127)
- [source/FetchManager.mc:134](c:/Users/alex/repos/garmin_df_wind_force/source/FetchManager.mc#L134)
...
- [docs/execution_plan.md:368](c:/Users/alex/repos/garmin_df_wind_force/docs/execution_plan.md#L368)
- [docs/execution_plan.md:372](c:/Users/alex/repos/garmin_df_wind_force/docs/execution_plan.md#L372)
- [docs/REQUIREMENTS.md:156](c:/Users/alex/repos/garmin_df_wind_force/docs/REQUIREMENTS.md#L156)
...
- [docs/execution_plan.md:391](c:/Users/alex/repos/garmin_df_wind_force/docs/execution_plan.md#L391)
- [docs/execution_plan.md:398](c:/Users/alex/repos/garmin_df_wind_force/docs/execution_plan.md#L398)
- [docs/REQUIREMENTS.md:208](c:/Users/alex/repos/garmin_df_wind_force/docs/REQUIREMENTS.md#L208)
- [docs/REQUIREMENTS.md:213](c:/Users/alex/repos/garmin_df_wind_force/docs/REQUIREMENTS.md#L213)

`StorageManager` has the right API for that:

- [source/StorageManager.mc:39](c:/Users/alex/repos/garmin_df_wind_force/source/StorageManager.mc#L39)
- [source/StorageManager.mc:55](c:/Users/alex/repos/garmin_df_wind_force/source/StorageManager.mc#L55)

But `WindForceView` never uses those functions. Instead, `findBestForecast()` just returns the most recently stored `fc_*` entry:

- [source/WindForceView.mc:57](c:/Users/alex/repos/garmin_df_wind_force/source/WindForceView.mc#L57)
- [source/WindForceView.mc:98](c:/Users/alex/repos/garmin_df_wind_force/source/WindForceView.mc#L98)
- [source/WindForceView.mc:102](c:/Users/alex/repos/garmin_df_wind_force/source/WindForceView.mc#L102)
...
- [source/FetchManager.mc:140](c:/Users/alex/repos/garmin_df_wind_force/source/FetchManager.mc#L140)
- [source/FetchManager.mc:151](c:/Users/alex/repos/garmin_df_wind_force/source/FetchManager.mc#L151)
- [source/FetchManager.mc:153](c:/Users/alex/repos/garmin_df_wind_force/source/FetchManager.mc#L153)
...
- pruning only tracks `fc_keys`, so `la_*` entries are invisible to [source/StorageManager.mc:86](c:/Users/alex/repos/garmin_df_wind_force/source/StorageManager.mc#L86) and do not obey the storage-retention limit from [docs/REQUIREMENTS.md:231](c:/Users/alex/repos/garmin_df_wind_force/docs/REQUIREMENTS.md#L231)
